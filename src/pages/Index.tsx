...
import { getUpcomingFestivals, getFeaturedFestivals, regions } from "@/utils/festivalData";
const Index = () => {
  ...
  return <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="md:w-2/3">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/regions" className="bg-white text-festival-red font-medium py-3 px-6 rounded-lg inline-flex items-center justify-center transition-colors hover:bg-festival-cream">
                <MapPin size={18} className="mr-2" />
                Explore Regions
              </Link>
              <Link to="/search" className="bg-transparent border-2 border-white text-white font-medium py-3 px-6 rounded-lg inline-flex items-center justify-center transition-colors hover:bg-white/10">
      ...
      <div className="container mx-auto px-4 py-12">
        {/* Upcoming Festivals */}
        <FestivalsList festivals={upcomingFestivals} title="Upcoming Festivals" emptyMessage="No upcoming festivals at the moment. Check back soon!" />
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredRegions.map(region => <RegionCard key={region.id} region={region} />)}
          </div>
        </div>
        
        {/* Featured Festivals */}
        <FestivalsList festivals={featuredFestivals} title="Featured Festivals" />
        ...
        <div className="bg-festival-cream rounded-lg p-8 text-center my-12">
          ...
          <Link to="/search" className="bg-festival-red text-white font-medium py-3 px-6 rounded-lg inline-flex items-center justify-center transition-colors hover:bg-festival-maroon">
            <Calendar size={18} className="mr-2" />
            Search by Date
          </Link>
        </div>
